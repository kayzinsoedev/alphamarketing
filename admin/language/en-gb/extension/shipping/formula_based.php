...
$_['heading_welcome']					= 'Welcome to ' . $_['heading_title'] . ' by FirstCom!';
$_['help_first_time']					= '
...
$_['entry_status']						= '<span data-toggle="tooltip" data-original-title="Set the status for the extension as a whole.">Status</span>';
$_['entry_sort_order']					= '<span data-toggle="tooltip" data-original-title="The sort order for the extension, relative to other ' . strtolower($type) . ' extensions.">Sort Order</span>';
$_['entry_heading']						= '<span data-toggle="tooltip" data-original-title="The heading under which these shipping options will appear. HTML is supported.<br /><br />Use the shortcodes [distance], [postcode], [quantity], [total], [volume], or [weight] to display the calculated value.">Heading</span>';
$_['entry_tax_class_id']				= '<span data-toggle="tooltip" data-original-title="Set the default tax class applied to ' . $row . 's. Any ' . $row . ' that does not have a \'Tax Class\' rule will use this tax class.">Default Tax Class</span>';

$_['entry_distance_calculation']		= '<span data-toggle="tooltip" data-original-title="Select the way distances are calculated. To change the origin of distance calculations, add a Setting Override rule to the ' . $row . ', and choose to override \'config_address\'">Distance Calculation</span>';
$_['text_driving_distance']				= 'Driving Distance';
$_['text_straightline_distance']		= 'Straight-line Distance';

$_['entry_distance_units']				= '<span data-toggle="tooltip" data-original-title="Select the unit type for distance comparisons.">Distance Units</span>';
$_['text_miles']						= 'Miles';
...
$_['entry_autosave']					= '<span data-toggle="tooltip" data-original-title="Choose whether settings are automatically saved. If you have this disabled and notice settings not getting saved, it means you should enable Automatic Saving (because your server has a max_input_vars limitation imposed).<br /><br />After changing this setting, reload the page to apply the change. You can tell a setting is being saved when it turns yellow, signaling that it cannot be edited while it is recorded to the database.">Automatic Saving</span>';
...
$_['entry_display']						= '<span data-toggle="tooltip" data-original-title="Set the way table rows are displayed by default when the page is loaded. If the extension admin panel is loading slowly, try selecting \'Collapsed\'.">Default Admin Display</span>';
$_['text_expanded']						= 'Expanded';
$_['text_collapsed']					= 'Collapsed';

$_['entry_tooltips']					= '<span data-toggle="tooltip" data-original-title="Disable to hide the tooltips that display for each setting. If the extension admin panel is loading slowly, try disabling Tooltips.">Tooltips</span>';
