<?php
class ControllerTmdformRecord extends Controller {
 private $error = array();
	...
	public function getList() {
		...
		$data['sort_title']  	= $this->url->link('tmdform/record', $tokenchange . '&sort=title' . $url, true);
		$data['sort_name']  	= $this->url->link('tmdform/record', $tokenchange . '&sort=name' . $url, true);
		$data['sort_ip']        = $this->url->link('tmdform/record', $tokenchange . '&sort=ip' . $url, true);
		$data['sort_date']  	= $this->url->link('tmdform/record', $tokenchange . '&sort=date' . $url, true);
		...
		$this->response->setOutput($this->load->view('tmdform/record_list',$data));
