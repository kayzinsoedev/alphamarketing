...
class ControllerEcadvancedreportsSaleCoupon extends Ec_Report_Abstract { 
	public function index() {   
		$this->initLoad();
		$data = $this->_data;
		$data['export'] = '';

		$this->template = 'module/ecadvancedreports/sale_coupon.tpl';
	...
	public function initLoad() {
		...
		$this->document->setTitle($this->language->get('heading_title_sales_coupon'));
		...
		$this->_data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title_sales_coupon'),
			'href'      => $this->url->link('ecadvancedreports/sale_coupon', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);
		...
		$this->_data['heading_title'] = $this->language->get('heading_title_sales_coupon');
		...
		$this->_data['column_coupon_code'] = $this->language->get('column_coupon_code');
	...
	protected function queryReports( $data ){
		...
		return $this->getModel()->getSaleByCoupon($data);
	}
}
?>