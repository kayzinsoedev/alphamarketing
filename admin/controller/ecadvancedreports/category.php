...
class ControllerEcadvancedreportsCategory extends Ec_Report_Abstract { 
	public function index() {
		$this->initLoad();
		$data = $this->_data;
		$data['export'] = '';

		$this->template = 'module/ecadvancedreports/sale_category.tpl';
	...
	public function initLoad() {
		...
		$this->document->setTitle($this->language->get('heading_title_sales_category'));
		...
		$this->_data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title_sales_category'),
			'href'      => $this->url->link('ecadvancedreports/category', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);
		...
		$this->_data['heading_title'] = $this->language->get('heading_title_sales_category');
		...
		$this->_data['column_category'] = $this->language->get('column_category');
		...
		$this->_data['column_payment'] = $this->language->get('column_payment');
	...
	protected function queryReports( $data ){
		...
		return $this->getModel()->getSaleByCategory($data);
	}
}
?>