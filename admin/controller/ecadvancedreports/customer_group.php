...
class ControllerEcadvancedreportsCustomerGroup extends Ec_Report_Abstract {
	var $_data = array();
	public function index() {
		...
		$this->template = 'module/ecadvancedreports/customer_group.tpl';
	...
	public function initLoad() {
		...
		$results = $this->model_ecadvancedreports_customer->getReport($data);
		$sum_total = 0;
		$sum_qty = 0;
		...
		$this->_data['heading_title'] = $this->language->get('heading_title_sales_by_customer_group');
