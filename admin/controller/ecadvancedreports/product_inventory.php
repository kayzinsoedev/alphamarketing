...
class ControllerEcadvancedreportsProductInventory extends Ec_Report_Abstract {
	public function index() {
		$this->initLoad();
		$data = $this->_data;
		$data['export'] = '';

		$this->template = 'module/ecadvancedreports/product_inventory.tpl';
	...
	public function initLoad($all_records = false) {
		...
		$this->_current_url = $this->url->link('ecadvancedreports/product_inventory', 'token=' . $this->session->data['token'].$url, 'SSL');
		...
		$this->_data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('ecadvancedreports/product_inventory', 'token=' . $this->session->data['token'].$url, 'SSL'),
			'separator' => ' :: '
		);
		...
		$this->_data['heading_title'] = $this->language->get('heading_title_product_inventory');
		...
		$pagination->url = $this->url->link('ecadvancedreports/product_inventory', 'token=' . $this->session->data['token'] . $url . '&page={page}', 'SSL');
	...
	public function export() {
		...
		$reports = array();
		$reports['name'] = 'product_inventory';
		$reports['data'] = array();
