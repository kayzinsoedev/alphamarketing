...
class ControllerEcadvancedreportsSalePayment extends Ec_Report_Abstract { 
	public function index() {   
		$this->initLoad();
		$data = $this->_data;
		$data['export'] = '';

		$this->template = 'module/ecadvancedreports/sale_payment.tpl';
	...
	public function initLoad() {
		...
		$this->document->setTitle($this->language->get('heading_title_sales_payment'));
		...
		$this->_data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title_sales_payment'),
			'href'      => $this->url->link('ecadvancedreports/sale_payment', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);
		...
		$this->_data['heading_title'] = $this->language->get('heading_title_sales_payment');
	...
	protected function queryReports( $data ){
		...
		return $this->getModel()->getSaleByPayment($data);
	}
}
?>