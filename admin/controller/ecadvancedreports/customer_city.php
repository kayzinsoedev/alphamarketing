...
class ControllerEcadvancedreportsCustomerCity extends Ec_Report_Abstract { 
	...
	public function initLoad($all_records = false) {
		...
		$this->document->setTitle($this->language->get('heading_title_customer_city'));
		...
		$this->_data['heading_title'] = $this->language->get('heading_title_customer_city');
