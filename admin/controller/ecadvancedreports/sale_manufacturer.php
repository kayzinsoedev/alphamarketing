...
class ControllerEcadvancedreportsSaleManufacturer extends Ec_Report_Abstract { 
	public function index() {   
		$this->initLoad();
		$data = $this->_data;
		$data['export'] = '';

		$this->template = 'module/ecadvancedreports/sale_manufacturer.tpl';
	...
	public function initLoad() {
		...
		$this->document->setTitle($this->language->get('heading_title_sales_manufacturer'));
		...
		$this->_data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title_sales_manufacturer'),
			'href'      => $this->url->link('ecadvancedreports/sale_manufacturer', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);
		...
		$this->_data['heading_title'] = $this->language->get('heading_title_sales_manufacturer');
	...
	public function export() {
		...
		$reports = array();
		$reports['name'] = 'sale_manufacturer';
		$reports['data'] = array();
	...
	protected function queryReports( $data ){
		...
		return $this->getModel()->getSaleByManufacturer($data);
	}
}
?>