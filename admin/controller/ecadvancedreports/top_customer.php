...
class ControllerEcadvancedreportsTopCustomer extends Ec_Report_Abstract {
	public function index() {
		$this->initLoad();
		$data = $this->_data;
		$data['export'] = '';

		$this->template = 'module/ecadvancedreports/top_customer.tpl';
	...
	public function initLoad($all_records = false) {
		...
		$this->document->setTitle($this->language->get('heading_title_top_customer'));
		...
		$this->_data['breadcrumbs'][] = array(
			'text'      => $this->language->get('heading_title_top_customer'),
			'href'      => $this->url->link('ecadvancedreports/top_customer', 'token=' . $this->session->data['token'], 'SSL'),
			'separator' => ' :: '
		);
		...
		$results = $this->getModel()->getTopCustomer($data);
		...
		if($results) {
			foreach($results as $key => $result) {
				...
				$sum_orders += (int)$result['total_sale'];
		...
		$this->_data['heading_title'] = $this->language->get('heading_title_top_customer');
