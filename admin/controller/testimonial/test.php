<?php
class ControllerTestimonialTest extends Controller {
	private $error = array();
	...
	protected function getForm() {
		...
		if (isset($this->request->post['short_excerpt'])) {
			$data['short_excerpt'] = $this->request->post['short_excerpt'];
		} elseif (!empty($review_info)) {
			$data['short_excerpt'] = $review_info['short_excerpt'];
		} else {
			$data['short_excerpt'] = '';
		}
