...
class ControllerLocalisationLocation extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['gmap_iframe'])) {
			$data['gmap_iframe'] = $this->request->post['gmap_iframe'];
		} elseif (!empty($location_info)) {
			$data['gmap_iframe'] = $location_info['gmap_iframe'];
		} else {
			$data['gmap_iframe'] = '';
		}
		...
		if (isset($this->request->post['region'])) {
			...
			$data['region'] = $location_info['region'];
		} else {
			$data['region'] =   '';
		}
