      ...
      <tbody>
        <tr>
          ...
          <td style="width: 50%;"><b><?php echo $text_date_added; ?></b> <?php echo $order['date_added']; ?><br />
            ...
            <?php if ($order['delivery_date'] != "0000-00-00") { ?>
              <b>
                  <?php echo $order['fulfillment_title']; ?>
              </b>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php if ($product['sku']) { ?>
            ...
            <?php } ?></td>
          <td><?php echo $product['name']; ?> <?php if($product['redeem'] == '1'){echo "<span style='color:red'>(Redeem)</span>";} ?>
