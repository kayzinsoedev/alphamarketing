      ...
      <?php if ($reports) { ?>
        <br/>
         <div class="table-responsive">
          ...
          <thead>
            <tr>
               <td class="text-left" style="width:10%"><?php echo $column_category; ?></td>
          ...
          <tbody>
            ...
            <?php if($report) { ?>
              <tr>
                <td class="text-left"><?php echo isset($report["category_name"])?$report['category_name']:"";?></td>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/category/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/category&token=<?php echo $token; ?>';
