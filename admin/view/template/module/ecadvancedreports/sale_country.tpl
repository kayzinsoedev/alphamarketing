        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-right">
              <?php
              $percent = 0;
              if($filter_reload_key == "order_total" && $sum_total) {
                $percent = ((float)$report['order_total'] * 100) / $sum_total;
              } elseif($sum_qty) {
                $percent = ((float)$report['order_quantity'] * 100) / $sum_qty;
              }
            ...
            <td class="text-right"><?php echo $report["order_quantity"];?></td>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/sale_country/export&token=<?php echo $token; ?>';
...
function filter() {
	url = 'index.php?route=ecadvancedreports/sale_country&token=<?php echo $token; ?>';
