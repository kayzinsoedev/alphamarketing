    ...
    <div class="content report_earnings panel panel-default">
      ...
      <?php if ($reports) { ?>
        ...
        <table class="list list-reports table table-bordered table-hover">
          <thead>
            <tr>
               <td class="text-left" style="width:20%"><?php echo $column_city; ?><br/>
                <input type="text" size="20" onkeyup="filter();" name="filter_city" id="filter_city" value="<?php echo isset($filter_city)?$filter_city:""; ?>"/></td>
          ...
          <tbody>
            ...
            <?php if($report) { ?>
              <tr>
                <td class="text-left"><?php echo isset($report["city_name"])?$report['city_name']:""; ?></td>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/customer_city/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/customer_city&token=<?php echo $token; ?>';
