    ...
    <div class="content report_earnings panel panel-default">
      ...
      <?php if ($reports) { ?>
         <table class="list list-reports table table-bordered table-hover">
          <thead>
            <tr>
               <td class="text-left" style="width:20%"><?php echo $column_country; ?><br/>
                <input type="text" size="20" onkeyup="filter();" name="filter_country" id="filter_country" value="<?php echo isset($filter_country)?$filter_country:""; ?>"/></td>
               <td class="text-left" style="width:10%"><?php echo $column_customers; ?></td>
          ...
          <tbody>
            ...
            <?php if($report) { ?>
              <tr>
                <td class="text-left"><?php echo isset($report["country_name"])?$report['country_name']:""; ?></td>
                <td class="text-right"><?php echo isset($report["customers"])?$report['customers']:0;?></td>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/customer_country/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/customer_country&token=<?php echo $token; ?>';
