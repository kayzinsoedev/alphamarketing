      ...
      <?php if ($reports) { ?>
        <table class="list list-reports table table-bordered table-hover">
          <thead class="blank-background">
            <tr>
               ...
               <td class="text-left"><?php if ($sort == 'o.date_added') { ?>
                    <a href="<?php echo $sort_date_added; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_order_date; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_date_added; ?>"><?php echo $column_order_date; ?></a>
                    <?php } ?></td>
               <td class="text-left"><?php if ($sort == 'quantity') { ?>
                    <a href="<?php echo $sort_quantity; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_qty_ordered; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_quantity; ?>"><?php echo $column_qty_ordered; ?></a>
                    <?php } ?></td>
               ...
               <td class="text-left"><?php if ($sort == 'o.total') { ?>
                    ...
                    <?php } ?></td>
               <td class="text-left"><?php if ($sort == 'tax') { ?>
               ...
               <td class="text-left"><?php if ($sort == 'total_cost') { ?>
                    <a href="<?php echo $sort_cost; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_total_cost; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_cost; ?>"><?php echo $column_total_cost; ?></a>
                    <?php } ?></td>
               <td class="text-left"><?php if ($sort == 'gross_profits') { ?>
                    <a href="<?php echo $sort_gross_profits; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_total_gross_profit; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_gross_profits; ?>"><?php echo $column_total_gross_profit; ?></a>
                    <?php } ?></td><!-- Gross profit = net sales (total) - cost (total cost) -->
               <td class="text-left"><?php if ($sort == 'net_profits') { ?>
                    <a href="<?php echo $sort_net_profits; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_total_net_profit; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_net_profits; ?>"><?php echo $column_total_net_profit; ?></a>
                    <?php } ?></td><!-- Net profit = gross profit - margin profit (tax + other costs) -->
          ...
          <tbody>
            ...
            <?php if($report) { ?>
              <tr>
                <td class="text-left"><?php  echo "#000".(isset($report["order_id"])?$report['order_id']:0); ?></td>
                <td class="text-right"><?php echo isset($report["invoice_no"])?$report['invoice_no']:"";?></td>
                <td class="text-right"><?php echo isset($report["status"])?$report['status']:"";?></td>
                <td class="text-right"><?php echo isset($report["date_added"])?$report['date_added']:"";?></td>
                ...
                <td class="text-right"><?php echo isset($report["gross_profits2"])?$report["gross_profits2"]:"0.00";?></td>
                <td class="text-right"><?php echo isset($report["total_net_profits2"])?$report["total_net_profits2"]:"0.00";?></td>
              ...
              <tr class="not_found">
                ...
                <td colspan="11" style="text-align:center"><?php echo $text_no_found_on_period;?></td>
              </tr>
              <?php } ?>
            <?php } ?>
          </tbody>
          <tfoot>
            <tr>
              ...
              <td class="text-right"><b><?php echo $sum_grossprofit_with_currency;?></b></td>
              <td class="text-right"><b><?php echo $sum_netprofit_with_currency;?></b></td>
              <td></td>
            </tr>
          </tfoot>
        </table>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/order/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/order&token=<?php echo $token; ?>';
