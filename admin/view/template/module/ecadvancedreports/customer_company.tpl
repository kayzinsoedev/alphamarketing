          ...
          <tr>
            ...
            <td class="text-right">
              ...
              if($filter_reload_key == "total" && $sum_total) {
                ...
                $percent = ((float)$report['orders'] * 100) / $sum_qty;
                $percent_value = (float)$report['orders'];
              }
            ...
            <td class="text-right"><?php echo $report["orders"];?></td>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/customer_company/export&token=<?php echo $token; ?>';
...
function filter() {
	url = 'index.php?route=ecadvancedreports/customer_company&token=<?php echo $token; ?>';
...
<script type="text/javascript"><!--
  ...
  function drawChart() {
    var data = google.visualization.arrayToDataTable([
      ['<?php echo $column_customer_company; ?>', '<?php echo $column_percent; ?>'],
      <?php 
           foreach($reports as $i=> $report) {
              ...
              ?>
              ['<?php echo $report["customer_company"]; ?>',  <?php echo $report['percent_value'] ?>]
              <?php 
              echo $comma;
           }
      ?>
