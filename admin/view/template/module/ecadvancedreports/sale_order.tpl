  ...
  <div class="container-fluid">
    ...
    <div class="content report_earnings panel panel-default">
      ...
      <div class="table-responsive">
            ...
            <table class="list list-reports table table-bordered table-hover">
              <thead>
                <tr>
                   ...
                   <td class="text-left" style="width:15%"><?php echo $column_subtotal; ?></td>
                   <td class="text-left hide"><?php echo $column_tax; ?></td>
                   <td class="text-left hide"><?php echo $column_shipping; ?></td>
                   <td class="text-left hide"><?php echo $column_discounts; ?></td>
                   <td class="text-left hide"><?php echo $column_total; ?></td>
                   <td class="text-left hide"><?php echo $column_refunded; ?></td>
                </tr>
              </thead>
              <tbody>
                ...
                <?php if($report) { ?>
                  <tr>
                    ...
                    <td class="text-right hide"><?php echo isset($report["tax2"])?$report["tax2"]:"0.00";?></td>
                    <td class="text-right hide"><?php echo isset($report["shipping2"])?$report["shipping2"]:"0.00";?></td>
                    <td class="text-right hide"><?php echo isset($report["discount2"])?$report["discount2"]:"0.00";?></td>
                    <td class="text-right column_color_yellow hide"><?php echo isset($report["total2"])?$report["total2"]:"0.00";?></td>
                    <td class="text-right column_color_orange hide"><?php echo isset($report["refunded2"])?$report["refunded2"]:"0.00";?></td>
                  </tr>
                  <?php } ?>
                <?php } ?>
              </tbody>
              <tfoot>
                <tr>
                  ...
                  <td class="text-right hide"><b><?php echo $sum_tax_with_currency;?></b></td>
                  <td class="text-right hide"><b><?php echo $sum_shipping_with_currency;?></b></td>
                  <td class="text-right hide"><b><?php echo $sum_discount_with_currency;?></b></td>
                  <td class="text-right column_color_yellow hide"><b><?php echo $sum_total_with_currency;?></b></td>
                  <td class="text-right column_color_orange hide"><b><?php echo $sum_refunded_with_currency;?></b></td>
                </tr>
              </tfoot>
            </table>
                ...
                <?php if($report) { ?>
                  <tr>
                    <td class="text-left"><?php echo $key; ?></td>
                     ...
                     <td class="text-right"><?php echo isset($report["number_ordered_by_guest"])?$report['number_ordered_by_guest']:0;?></td>
                    
                    <td class="text-right"><?php echo isset($report["items_ordered_by_guest"])?$report["items_ordered_by_guest"]:"0";?></td>

                    <td class="text-right column_color_blue"><?php echo isset($report["total2_1"])?$report["total2_1"]:"0.00";?></td>
              ...
              <tfoot>
                <tr>
                  <td class="text-left">
                   ...
                   <td class="text-right"><b><?php echo $sum_number_ordered_by_guest; ?></b></td>

                  <td class="text-right"><b><?php echo $sum_items_ordered1;?></b></td>

                  <td class="text-right column_color_blue"><b><?php echo $sum_number_ordered_by_guest_total;?></b></td>
                  
                  <td class="text-right hide"><b><?php echo $sum_tax_1;?></b></td>
                  <td class="text-right hide"><b><?php echo $sum_shipping_with_currency;?></b></td>
                  <td class="text-right hide"><b><?php echo $sum_discount_with_currency;?></b></td>
                  <td class="text-right column_color_yellow hide"><b><?php echo $sum_total_with_currency;?></b></td>
                  <td class="text-right column_color_orange hide"><b><?php echo $sum_refunded_with_currency;?></b></td>
			...
			<table class="list list-reports table table-bordered table-hover">
              ...
              <tbody>
                ...
                <?php if($report) { ?>
                  <tr>
                    <td class="text-left"><?php echo $key; ?></td>
                      <td class="text-right"><?php echo isset($report["number_ordered_by_first_order"])?$report['number_ordered_by_first_order']:0;?></td>

                    <td class="text-right"><?php echo isset($report["items_ordered_by_first_order"])?$report["items_ordered_by_first_order"]:"0";?></td>

                    <td class="text-right column_color_blue"><?php echo isset($report["total2_2"])?$report["total2_2"]:"0.00";?></td>
              ...
              <tfoot>
                <tr>
                  <td class="text-left">
                    ...
                    <td class="text-right"><b><?php echo $sum_number_ordered_by_first_order; ?></b></td>
                  
                  <td class="text-right"><b><?php echo $sum_items_ordered2;?></b></td>
				  
                  <td class="text-right column_color_blue"><b><?php echo $sum_number_ordered_by_first_order_total;?></b></td>
                ...
                <?php if($report) { ?>
                  <tr>
                    <td class="text-left"><?php echo $key; ?></td>
                       ...
                       <td class="text-right"><?php echo isset($report["number_ordered_by_second_order"])?$report['number_ordered_by_second_order']:0;?></td>
                    
                    <td class="text-right"><?php echo isset($report["items_ordered_by_second_order"])?$report["items_ordered_by_second_order"]:"0";?></td>

                    <td class="text-right column_color_blue"><?php echo isset($report["total2_3"])?$report["total2_3"]:"0.00";?></td>
                ...
                <tr>
                  <td class="text-left">
                    <?php echo $text_total; ?>
                     ...
                     <td class="text-right"><b><?php echo $sum_number_ordered_by_second_order; ?></b></td>
                  
                  <td class="text-right"><b><?php echo $sum_items_ordered3;?></b></td>

                  <td class="text-right column_color_blue"><b><?php echo $sum_number_ordered_by_second_order_total;?></b></td>
          ...
          <?php } ?>
            <?php /* if($predictive_data){ ?>
              <br />
              <h3>Predictive Analytics</h3>
              <table class="predictive-table list list-reports table table-bordered table-hover">
                <thead>
                  <tr>
                     <td class="text-left" style="width:10%"><?php echo $column_period; ?></td>
                     <td class="text-left" style="width:10%"><?php echo $column_number_orders; ?></td>
                     <td class="text-left" style="width:10%"><?php echo $column_items_ordered; ?></td>
                     <td class="text-right" style="width:15%"><?php echo $column_total; ?></td>
                     <td style="width:55%"></td>
                  </tr>
                </thead>
                <tbody>
                    <?php foreach($predictive_data as $key => $predictive){ ?>
                      <tr>
                        <td class="text-left"><?=$key; ?></td>
                        <td class="text-right"><?=$predictive['order_number']; ?></td>
                        <td class="text-right"><?=$predictive['order_item_number']; ?></td>
                        <td class="text-right column_color_blue"><?=$predictive['total']; ?></td>
                        <td></td>
                      </tr>
                    <?php } ?>
                </tbody>
                <tfoot>
                  <tr>
                    ...
                    <td class="text-right"><b><?=$sum_predictive_order; ?></b></td>
                    <td class="text-right"><b><?=$sum_predictive_item_number; ?></b></td>
                    <td class="text-right"><b><?=$sum_predictive_total; ?></b></td>
                    <td></td>
                  </tr>
                </tfoot>
              </table>
