     ...
     <?php if($export != "html") { ?>
      ...
      <?php if ($reports) { ?>
         ...
         <div class="table-responsive">
          ...
          <thead>
            <tr>
               <td class="text-left" style="width:10%"><?php echo $column_coupon_code; ?></td>
          ...
          <tbody>
            ...
            <?php if($report) { ?>
              <tr>
                <td class="text-left"><?php echo isset($report["coupon_code"])?$report['coupon_code']:"";?></td>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/sale_coupon/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/sale_coupon&token=<?php echo $token; ?>';
