    ...
    <div class="content report_earnings panel panel-default">
      ...
      <?php if ($reports) { ?>
        <table class="list list-reports table table-bordered table-hover">
          <thead>
            <tr>
               <td class="text-left" style="width:10%"><?php echo $column_state; ?></td>
          ...
          <tbody>
            ...
            <?php if($report) { ?>
              <tr>
                <td class="text-left"><a href="<?php echo $report['link'];?>" title="<?php $text_show_report_detail; ?>"><?php echo isset($report["zone_name"])?$report['zone_name']:"";?></a></td>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/sale_state/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/sale_state&token=<?php echo $token; ?>';
