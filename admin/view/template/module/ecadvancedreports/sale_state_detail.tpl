    ...
    <div class="content report_earnings panel panel-default">
      ...
      <?php if ($reports) { ?>
        <table class="list list-reports table table-bordered table-hover">
          <thead>
            <tr>
               <td class="text-left" style="width:10%"><?php echo $column_order_id; ?></td>
               <td class="text-left"><?php echo $column_added_date; ?></td>
          ...
          <tbody>
            ...
            <?php if($report) { ?>
              <tr>
                <td class="text-left"><a href="<?php echo $report['order_url']; ?>" target="_BLANK"><?php echo isset($report["order_id"])?$report['order_id']:"";?></a></td>
                <td class="text-right"><?php echo isset($report["date_added"])?$report['date_added']:"";?></td>
                <td class="text-right"><a href="<?php echo $report['customer_url'];?>" target="_BLANK"><?php echo isset($report["customer_name"])?$report['customer_name']:"";?></a></td>
              ...
              <tr class="not_found">
                ...
                <td colspan="9" style="text-align:center"><?php echo $text_no_found_on_period;?></td>
              </tr>
              <?php } ?>
            <?php } ?>
          </tbody>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/sale_state_detail/export&token=<?php echo $token; ?>';
  ...
  url += '&zone_id=' + encodeURIComponent("<?php echo $zone_id; ?>");

  url += '&zone_name=' + encodeURIComponent("<?php echo $zone_name; ?>");
...
function filter() {
  url = 'index.php?route=ecadvancedreports/sale_state_detail&token=<?php echo $token; ?>';
