      ...
      <?php if ($reports) { ?>
          ...
          <thead>
            <tr>
               ...
               <td class="text-left"><?php echo $column_order_amount_avg; ?></td>
               <td class="text-left"><?php echo $column_item_final_price_avg; ?></td>
            </tr>
          </thead>
          <tbody>
            ...
            <?php if($report) { ?>
              <tr>
                ...
                <td class="text-right"><?php echo isset($report["total_avg2"])?$report["total_avg2"]:"0.00";?></td>
                <td class="text-right"><?php echo isset($report["product_total_avg2"])?$report["product_total_avg2"]:"0.00";?></td>
              </tr>
              <?php } else { ?>
              <tr class="not_found">
                <td class="text-left"><?php echo $key; ?></td>
                <td colspan="10" style="text-align:center"><?php echo $text_no_found_on_period;?></td>
              </tr>
              <?php } ?>
            <?php } ?>
          </tbody>
...
function ecExport() {
 url = 'index.php?route=ecadvancedreports/sale_statistics/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/sale_statistics&token=<?php echo $token; ?>';
...
<?php
      ...
      foreach($reports as $key=>$val) {
        if($val) {
          $tmp[] = "['".$key."', ".(isset($val["total_avg"])?$val["total_avg"]:"0.00").",".(isset($val["product_total_avg"])?$val["product_total_avg"]:"0.00")."]";
        }
      }
?>
  <?php  if($tmp) {  ?>
  <script type="text/javascript"><!--
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ['<?php echo $language->get("text_date");?>','<?php echo $column_order_amount_avg; ?>','<?php echo $column_item_final_price_avg; ?>'],
        <?php
          echo implode(",", $tmp);
      ...
      var options = {
        ...
        hAxis: {title: '<?php echo $language->get("text_date");?>', titleTextStyle: {color: 'red'}}
      };
