    ...
    <?php } ?>
      ...
      <div class="table-responsive">
       <table class="list list-reports table table-bordered table-hover">
        <thead>
          <tr>
            <td class="text-left" style="width:10%"><?php echo $column_hour; ?></td>
            <td class="text-left"><?php echo $column_percent; ?></td>
            <td class="text-left"><?php echo 25 ?></td>
            <td class="text-left"><?php echo 24 ?></td>
          </tr>
        </thead>
        <tbody>
          <?php if ($reports) { ?>
          ...
          <tr>
            <td class="text-dright"><?php echo $key; ?></td>
            <td class="text-left">
              <?php
              $percent = 0;
              ...
              $reports[$key]['percent'] = round($percent, 2);
              ?>
            ...
            <td class="text-left"><?php echo $report["total2"];?></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
        ...
        <tfoot>
          <tr>
            ...
            <td class="text-"><b><?php echo $sum_total_with_currency;?></b></td>
          </tr>
        </tfoot>
        <?php } ?>
      </table>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/sale_hour/export&token=<?php echo $token; ?>';
...
function filter() {
	url = 'index.php?route=ecadvancedreports/sale_hour&token=<?php echo $token; ?>';
...
<script type="text/javascript">
  ...
  function drawChart() {
      var data = google.visualization.arrayToDataTable([
                  ['<?php echo $language->get("text_date");?>','<?php echo $column_percent; ?>', { role: "style" }],
                  <?php
                    $tmp = array();
                    foreach($reports as $key=>$val) {
                         if($val) {
                            $tmp[] = "['".$key."', ".(isset($val["percent"])?$val["percent"]:"0").", 'color:#".$chart_color."']";
                          }
                    }
      ...
      var options = {
                  title: "<?php echo $language->get("text_report_sale_by_hour");?>",
                  bar: {groupWidth: "85%"},
