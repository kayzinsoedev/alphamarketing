   ...
   <?php if($export != "html") { ?>
      ...
      <?php if ($reports) { ?>
        <table class="list list-reports table table-bordered table-hover">
          <thead>
            <tr>
               <td class="text-left" style="width:10%"><?php echo $column_payment; ?></td>
          ...
          <tbody>
            ...
            <?php if($report) { ?>
              <tr>
                <td class="text-left"><?php echo isset($report["payment_method"])?$report['payment_method']:"";?></td>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/sale_payment/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/sale_payment&token=<?php echo $token; ?>';
