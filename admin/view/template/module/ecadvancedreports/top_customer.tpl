      ...
      <table class="list list-reports table table-bordered table-hover">
        <thead>
          <tr>
            ...
            <td class="text-left"><?php echo $column_customer_company; ?></td>
            <td class="text-left" style="width:40%"><?php echo $column_email; ?></td>
            <td class="text-left"><?php echo $column_percent; ?></td>
            <td class="text-left"><?php echo $column_total_orders; ?></td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-left"><?php echo $report['customer_company']; ?></td>
             <td class="text-left"><?php echo $report['email']; ?></td>
            <td class="text-right">
              <?php
              $percent = 0;
              $percent_value = 0;
              if($filter_reload_key == "subtotal" && $sum_subtotal) {
                $percent = ((float)$report['subtotal'] * 100) / $sum_subtotal;
                $percent_value = (float)$report['subtotal'];
              } elseif($sum_orders) {
                $percent = ((float)$report['total_sale'] * 100) / $sum_orders;
                $percent_value = (float)$report['total_sale'];
              }
            ...
            <td class="text-right"><?php echo $report['total_sale']; ?></td>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/top_customer/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/top_customer&token=<?php echo $token; ?>';
...
<script type="text/javascript"><!--
  ...
  function drawChart() {
    var data = google.visualization.arrayToDataTable([
      ['<?php echo $column_customer_name; ?>', '<?php echo $column_percent; ?>'],
      <?php 
           foreach($reports as $i=> $report) {
              ...
              ?>
              ['<?php echo $report["customer_name"]; ?>',  <?php echo $report['percent_value'] ?>]
              <?php 
              echo $comma;
           }
      ?>
