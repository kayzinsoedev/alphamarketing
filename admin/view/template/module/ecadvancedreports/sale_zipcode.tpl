    ...
    <div class="content report_earnings panel panel-default">
      ...
      <div class="table-responsive">
        <!-- <?php if ($reports) { ?>
          <table class="list list-reports table table-bordered table-hover">
            <thead>
              <tr>
                 <td class="text-left" style="width:10%"><?php echo $column_zipcode; ?></td>
            ...
            <tbody>
              ...
              <?php if($report) { ?>
                <tr>
                  <td class="text-left"><?php echo isset($report["zipcode"])?$report['zipcode']:"";?></td>
      ...
      <?php if ($districts) { ?>
          <table class="list list-reports table table-bordered table-hover">
            <thead>
              <tr>
                 <td class="text-left" style="width:10%"><?php echo $column_district; ?></td>
                 <td class="text-left"><?php echo $column_postal_sector; ?></td>
                 <td class="text-left"><?php echo $column_general_location; ?></td>
                 <td class="text-left" style="width:10%"><?php echo $column_number_orders; ?></td>
                 <td class="text-left" style="width:10%"><?php echo $column_items_ordered; ?></td>
                 <td class="text-left"><?php echo $column_total; ?></td>
                 <td class="text-left" style="width:10%"><?php echo $column_next_month; ?></td>
                 <td class="text-left" style="width:10%"><?php echo $column_next_2month; ?></td>
                 <td class="text-left" style="width:10%"><?php echo $column_next_3month; ?></td>
              </tr>
            </thead>
            <tbody>
              <?php foreach ($districts as $key => $district) { ?>
                <tr>
                  ...
                  <td class="text-right"><?=$district['postal_sector']; ?></td>
                  <td class="text-right"><?=$district['general_location']; ?></td>
                  <td class="text-right"><?php echo isset($district["number_orders"])?$district['number_orders']:0;?></td>
                  <td class="text-right"><?php echo isset($district["items_ordered"])?$district["items_ordered"]:"0";?></td>
                  <td class="text-right column_color_yellow"><?php echo isset($district["total2"])?$district["total2"]:"0.00";?></td>
                  <td class="text-right <?=$district['man_power']['next_month']>0?'green':'red'; ?>"><b><?=$district['man_power']['next_month']; ?>%</b> <?=$district['man_power']['next_month']>0?'<i class="fa fa-arrow-up" aria-hidden="true"></i>':'<i class="fa fa-arrow-down" aria-hidden="true"></i>'; ?></td>
                  <td class="text-right <?=$district['man_power']['next_2month']>0?'green':'red'; ?>"><b><?=$district['man_power']['next_2month']; ?>%</b> <?=$district['man_power']['next_2month']>0?'<i class="fa fa-arrow-up" aria-hidden="true"></i>':'<i class="fa fa-arrow-down" aria-hidden="true"></i>'; ?></td>
                  <td class="text-right <?=$district['man_power']['next_3month']>0?'green':'red'; ?>"><b><?=$district['man_power']['next_3month']; ?>%</b> <?=$district['man_power']['next_3month']>0?'<i class="fa fa-arrow-up" aria-hidden="true"></i>':'<i class="fa fa-arrow-down" aria-hidden="true"></i>'; ?></td>
                </tr>
              <?php } ?>
            </tbody>
            <tfoot>
              <tr>
                ...
                <td class="text-right"><b><?php echo $district_sum_order; ?></b></td>
                <td class="text-right"><b><?php echo $district_sum_item_ordered;?></b></td>
                <td class="text-right"><b><?php echo $district_sum_total;?></b></td>
          ...
          <div class="pagination hide"><?php echo $pagination; ?></div>
      <?php } else { ?>
        <?php echo $text_no_results; ?>
      <?php } ?>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/sale_zipcode/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/sale_zipcode&token=<?php echo $token; ?>';
