        ...
        <tr>
          <td>
            <table>
              ...
              <td><?php echo $entry_number_items; ?>
      ...
      <div class="table-responsive">
        ...
        <thead>
          <tr>
            ...
            <td class="text-left"><?php echo $column_customer_firstname; ?></td>
            <td class="text-left"><?php echo $column_customer_lastname; ?></td>
            <td class="text-left"><?php echo $column_email; ?></td>
            <td class="text-left"><?php echo $column_company; ?></td>
            <td class="text-left"><?php echo $column_number_orders; ?></td>
            ...
            <td class="text-left"><?php echo $column_tax_amount; ?></td>
            <td class="text-left"><?php echo $column_discounts; ?></td>
            <td class="text-left"><?php echo $column_shipping_city; ?></td>
            <td class="text-left"><?php echo $column_shipping_postcode; ?></td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-left"><?php echo $report['lastname']; ?></td>
            <td class="text-left"><?php echo $report['email']; ?></td>
            <td class="text-left"><?php echo $report['company']; ?></td>
            <td class="text-right"><?php echo $report['number_order']; ?></td>
            <td class="text-right"><?php echo $report["subtotal2"];?></td>
            <td class="text-right"><?php echo $report["total2"];?></td>
            <td class="text-right"><?php echo $report["shipping2"];?></td>
            <td class="text-right"><?php echo $report["tax2"];?></td>
            <td class="text-right"><?php echo $report["discount2"];?></td>
            <td class="text-right"><?php echo $report["shipping_city"];?></td>
            <td class="text-right"><?php echo $report["shipping_postcode"];?></td>
            <td class="text-right"><a href="<?php echo $report["customer_url"];?>" target="_BLANK"><?php echo $language->get("text_view");?></a></td>
          </tr>
          <?php } ?>
          <?php } else { ?>
          <tr>
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/customer/export&token=<?php echo $token; ?>';
...
function filter() {
  url = 'index.php?route=ecadvancedreports/customer&token=<?php echo $token; ?>';
