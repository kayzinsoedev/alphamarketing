    ...
    <div class="content report_earnings panel panel-default">
      ...
      <table class="list list-reports table table-bordered table-hover">
        ...
        <tbody>
          ...
          <tr>
            <td class="text-left"><?php echo $report['customer_group']; ?></td>
            <td class="text-right">
              <?php
              $percent = 0;
              $percent_value = 0;
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/customer_group/export&token=<?php echo $token; ?>';
...
function filter() {
	url = 'index.php?route=ecadvancedreports/customer_group&token=<?php echo $token; ?>';
...
<script type="text/javascript"><!--
  ...
  function drawChart() {
    var data = google.visualization.arrayToDataTable([
      ['<?php echo $column_customer_group; ?>', '<?php echo $column_percent; ?>'],
      <?php 
           foreach($reports as $i=> $report) {
              ...
              ?>
              ['<?php echo $report["customer_group"]; ?>',  <?php echo $report['percent_value'] ?>]
              <?php 
              echo $comma;
           }
      ?>
