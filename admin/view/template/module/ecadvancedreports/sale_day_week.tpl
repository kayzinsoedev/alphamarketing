  ...
  <div class="container-fluid">
    <?php if($export != "html") { ?>
      ...
      <table class="list list-reports table table-bordered table-hover">
        <thead>
          <tr>
            <td class="text-left" style="width:20%"><?php echo $column_day_of_week; ?></td>
        ...
        <tbody>
          ...
          <tr>
            <td class="text-left"><?php echo $report['date']; ?></td>
            <td class="text-left">
              <?php
              $percent = 0;
...
function ecExport() {
  url = 'index.php?route=ecadvancedreports/sale_day_week/export&token=<?php echo $token; ?>';
...
function filter() {
	url = 'index.php?route=ecadvancedreports/sale_day_week&token=<?php echo $token; ?>';
...
<script type="text/javascript">
  ...
  function drawChart() {
      var data = google.visualization.arrayToDataTable([
                  ...
                  <?php
                    ...
                    foreach($reports as $key=>$val) {
                         if($val) {
                            $tmp[] = "['".$val['date']."', ".(isset($val["percent"])?$val["percent"]:"0").", 'color:#".$chart_color."']";
                          }
                    }
      ...
      var options = {
                  title: "<?php echo $language->get("text_report_sale_by_day_of_week");?>",
                  bar: {groupWidth: "85%"},
