        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="summary_top">
              <ul>
                <li class="no-border-right"><p class="text"><?php echo $column_quantity; ?></p><p class="number"><?php echo $sales_sum_items_ordered; ?></p></li>
                <li class="no-border-right"><p class="text">No. of Orders</p><p class="number"><?php echo $sales_sum_orders; ?></p></li>
                <li class="no-border-right"><p class="text"><?php echo $column_product_revenue; ?></p><p class="number"><?php echo $sales_sum_total;?></p></li>
       ...
       <table class="list list-reports table table-bordered table-hover">
          <thead>
            <tr>
               ...
               <td class="text-left"><?php echo $column_quantity_sold; ?></td>
               ...
               <td class="text-left"><?php echo $column_optimal_price; ?></td>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><?php echo isset($report["predictive_qty_month1"])?$report["predictive_qty_month1"]:"0";?></td>
              <td class="text-right"><?php echo isset($report["predictive_qty_month2"])?$report["predictive_qty_month2"]:"0";?></td>
              <td class="text-right"><?php echo isset($report["predictive_qty_month3"])?$report["predictive_qty_month3"]:"0";?></td>
          ...
          <tfoot>
            <tr>
              ...
              <td></td>
              <td class="text-right"><b><?php echo $sum_predictive;?></b></td>
              <td class="text-right"><b><?php echo $sum_predictive2;?></b></td>
              <td class="text-right"><b><?php echo $sum_predictive3;?></b></td>
              <!-- <td></td>
              <td></td> -->
            </tr>
          </tfoot>
