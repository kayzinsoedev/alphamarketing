		...
		<?php foreach ($languages as $language) { ?>
			<div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
				...
				<div class="form-group required">
                    ...
                    <div class="col-sm-10">
					  <input type="text" name="service_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset( $service_description[$language['language_id']]['title']) ? $service_description[$language['language_id']]['title'] : ''; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control" />
                ...
                <div class="form-group required">
                    ...
                    <div class="col-sm-10">
					  <textarea name="service_description[<?php echo $language['language_id']; ?>][description]" id="input-description<?php echo $language['language_id']; ?>" class="form-control 7"><?php echo isset( $service_description[$language['language_id']]['description']) ? $service_description[$language['language_id']]['description'] : ''; ?></textarea>
				...
				<div id="sdesc<?php echo $language['language_id']; ?>">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<textarea name="service_description[<?php echo $language['language_id']; ?>][description2]" id="input-descriptions<?php echo $language['language_id']; ?>" class="form-control "><?php echo isset( $service_description[$language['language_id']]['description2']) ? $service_description[$language['language_id']]['description2'] : ''; ?></textarea>
							</div>
						</div>
				</div>
			</div>
	...
	<?php foreach ($languages as $language) { ?>
	 <div class="tab-pane" id="languageseo<?php echo $language['language_id']; ?>">
            ...
            <div class="form-group">
                    ...
                    <div class="col-sm-10">
					  <input type="text" name="service_description[<?php echo $language['language_id']; ?>][ctitle]" value="<?php echo isset( $service_description[$language['language_id']]['ctitle']) ? $service_description[$language['language_id']]['ctitle'] : ''; ?>" id="input-meta-title<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
            </div>
			<div class="form-group">
                    ...
                    <div class="col-sm-10">
					  <textarea name="service_description[<?php echo $language['language_id']; ?>][meta_desc]" rows="5" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset( $service_description[$language['language_id']]['meta_desc']) ? $service_description[$language['language_id']]['meta_desc'] : ''; ?></textarea>
                    </div>
            </div>
			<div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-key<?php echo $language['language_id']; ?>"><?php echo $entry_meta_key; ?></label>
                    <div class="col-sm-10">
					  <textarea name="service_description[<?php echo $language['language_id']; ?>][meta_key]" rows="5" id="input-meta-key<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset( $service_description[$language['language_id']]['meta_key']) ? $service_description[$language['language_id']]['meta_key'] : ''; ?></textarea>
                    </div>
            </div>
			<div class="form-group hidden">
                    <label class="col-sm-2 control-label" for="input-ntags<?php echo $language['language_id']; ?>"><?php echo $entry_ntags; ?></label>
                    <div class="col-sm-10">
					  <input type="text" name="service_description[<?php echo $language['language_id']; ?>][ntags]" value="<?php echo isset( $service_description[$language['language_id']]['ntags']) ? $service_description[$language['language_id']]['ntags'] : ''; ?>" id="input-ntags<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
            </div>
	 </div>
	<?php } ?>
...
<div class="tab-pane" id="tab-custom">
	...
	<div class="tab-pane" id="languagesc<?php echo $language['language_id']; ?>">
				<div class="form-group">
                    ...
                    <div class="col-sm-10">
					  <input type="text" name="service_description[<?php echo $language['language_id']; ?>][cfield1]" value="<?php echo isset( $service_description[$language['language_id']]['cfield1']) ? $service_description[$language['language_id']]['cfield1'] : ''; ?>" id="input-cfield1<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
				</div>
				<div class="form-group">
                    <label class="col-sm-2 control-label" for="input-cfield2<?php echo $language['language_id']; ?>"><?php echo $entry_cfield; ?> 2</label>
                    <div class="col-sm-10">
					  <input type="text" name="service_description[<?php echo $language['language_id']; ?>][cfield2]" value="<?php echo isset( $service_description[$language['language_id']]['cfield2']) ? $service_description[$language['language_id']]['cfield2'] : ''; ?>" id="input-cfield2<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
				</div>
				<div class="form-group">
                    <label class="col-sm-2 control-label" for="input-cfield3<?php echo $language['language_id']; ?>"><?php echo $entry_cfield; ?> 3</label>
                    <div class="col-sm-10">
					  <input type="text" name="service_description[<?php echo $language['language_id']; ?>][cfield3]" value="<?php echo isset( $service_description[$language['language_id']]['cfield3']) ? $service_description[$language['language_id']]['cfield3'] : ''; ?>" id="input-cfield3<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
				</div>
				<div class="form-group">
                    <label class="col-sm-2 control-label" for="input-cfield4<?php echo $language['language_id']; ?>"><?php echo $entry_cfield; ?> 4</label>
                    <div class="col-sm-10">
					  <input type="text" name="service_description[<?php echo $language['language_id']; ?>][cfield4]" value="<?php echo isset( $service_description[$language['language_id']]['cfield4']) ? $service_description[$language['language_id']]['cfield4'] : ''; ?>" id="input-cfield4<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
				</div>
	</div>
	<?php } ?>
...
<div class="tab-pane" id="tab-settings">
          ...
          <div class="col-sm-10">
            <div class="well well-sm" style="height: 150px; overflow: auto;">
              ...
              <div class="checkbox">
                <label>
                  <?php if (in_array($category['ncategory_id'], $service_ncategory)) { ?>
      <input type="checkbox" name="service_ncategory[]" value="<?php echo $category['ncategory_id']; ?>" checked="checked" />
      <?php echo $category['name']; ?>
                  <?php } else { ?>
      <input type="checkbox" name="service_ncategory[]" value="<?php echo $category['ncategory_id']; ?>" />
      <?php echo $category['name']; ?>
                  <?php } ?>
                </label>
              </div>
              ...
              <div class="form-group hidden">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div class="checkbox">
                      <label>
                        <?php if (in_array($group['customer_group_id'], $service_group)) { ?>
                        <input type="checkbox" name="service_group[]" value="<?php echo $group['customer_group_id']; ?>" checked="checked" />
                        <?php echo $group['name']; ?>
                        <?php } else { ?>
                        <input type="checkbox" name="service_group[]" value="<?php echo $group['customer_group_id']; ?>" />
                        <?php echo $group['name']; ?>
                        <?php } ?>
                      </label>
                    </div>
...
<div class="tab-pane" id="tab-related">
			<div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="service-nrelated" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($service_nrelated as $service_nrelated) { ?>
						<div id="service-nrelated<?php echo $service_nrelated['service_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $service_nrelated['title']; ?>
							<input type="hidden" name="service_nrelated[]" value="<?php echo $service_nrelated['service_id']; ?>" />
						</div>
                    <?php } ?>
                  </div>
                </div>
			...
			<div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <div id="service-related" class="well well-sm" style="height: 150px; overflow: auto;">
                    <?php foreach ($service_related as $service_related) { ?>
						<div id="service-related<?php echo $service_related['product_id']; ?>"><i class="fa fa-minus-circle"></i> <?php echo $service_related['name']; ?>
							<input type="hidden" name="service_related[]" value="<?php echo $service_related['product_id']; ?>" />
						</div>
                    <?php } ?>
                  </div>
                </div>
...
<div class="tab-pane" id="tab-video">
 <div class="table-responsive">
	<table id="video" class="table table-striped table-bordered table-hover">
            ...
            <?php $video_row = 0; ?>
            <?php foreach ($service_video as $video) { ?>
            <tbody id="video-row<?php echo $video_row; ?>">
              <tr>
                <td class="text-left">
					<input type="text" name="service_video[<?php echo $video_row; ?>][video]" value="<?php echo $video['video']; ?>" size="20" />
				</td>
				<td class="text-left">
					...
					<?php foreach ($languages as $language) { ?>
						...
						<textarea name="service_video[<?php echo $video_row; ?>][text][<?php echo $language['language_id']; ?>]" rows="2" cols="30"><?php echo isset($video['text'][$language['language_id']]) ? $video['text'][$language['language_id']] : '' ; ?></textarea><br />
					<?php } ?>
				</td>
                <td class="text-left"><input type="text" name="service_video[<?php echo $video_row; ?>][width]" value="<?php echo $video['width']; ?>" size="3" />
				<input type="text" name="service_video[<?php echo $video_row; ?>][height]" value="<?php echo $video['height']; ?>" size="3" />
				</td>
                <td class="text-right"><input type="text" name="service_video[<?php echo $video_row; ?>][sort_order]" value="<?php echo $video['sort_order']; ?>" size="2" /></td>
                <td class="text-left"><a onclick="$('#video-row<?php echo $video_row; ?>').remove();" class="button btn btn d"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $video_row++; ?>
            <?php } ?>
 ...
 <div class="table-responsive">
	<table id="gallery" class="table table-striped table-bordered table-hover">
            <thead>
              ...
              <td class="text-left hidden"><?php echo $entry_gallery_text; ?></td>
            ...
            <tbody>
            <?php $image_row = 0; ?>
            <?php foreach ($service_gallery as $service_image) { ?>
            
              <tr id="image-row<?php echo $image_row; ?>">
                <td class="text-left">
				
            <a href="" id="thumb-image<?php echo $image_row; ?>-gallery" data-toggle="image" class="img-thumbnail"><img src="<?php echo $service_image['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="service_gallery[<?php echo $image_row; ?>][image]" value="<?php echo $service_image['image']; ?>" id="input-image<?php echo $image_row; ?>-gallery" />
            
            </td>
				<td class="text-left hidden">
					<?php $service_image['text'] = unserialize($service_image['text']); ?>
					<?php foreach ($languages as $language) { ?>
						<img style="margin: 10px;" src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
						<textarea name="service_gallery[<?php echo $image_row; ?>][text][<?php echo $language['language_id']; ?>]" rows="2" cols="30"><?php echo isset($service_image['text'][$language['language_id']]) ? $service_image['text'][$language['language_id']] : '' ; ?></textarea><br />
					<?php } ?>
				</td>
                <td class="text-right hidden"><input type="text" name="service_gallery[<?php echo $image_row; ?>][sort_order]" value="<?php echo $service_image['sort_order']; ?>" size="2" /></td>
                <td class="text-left"><a onclick="$('#image-row<?php echo $image_row; ?>').remove();" class="button btn btn-danger"><?php echo $button_remove; ?></a></td>
              </tr>
            ...
            <tfoot>
              <tr>
                <td colspan="1"></td>
                <td class="left"><a onclick="addGallery();" class="button btn btn-primary"><?php echo $button_add_image; ?></a></td>
              </tr>
            </tfoot>
          </table>
 </div>
                ...
                <table class="table table-bordered table-hover">
				  ...
				  <tbody>
					<tr>
						...
						<td class="left"><select name="service_layout[0]">
							<option value=""></option>
					...
					<?php foreach ($stores as $store) { ?>
						<tr>
							...
							<td class="left"><select name="service_layout[<?php echo $store['store_id']; ?>]">
								<option value=""></option>
								<?php foreach ($layouts as $layout) { ?>
...
$('input[name=\'nrelated\']').autocomplete({
	'source': function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/service/autocomplete&token=<?php echo $token; ?>&filter_aname=' +  encodeURIComponent(request),
			dataType: 'json',			
	...
	'select': function(item) {
		...
		$('#service-nrelated' + item['value']).remove();
		
		$('#service-nrelated').append('<div id="service-nrelated' + item['value'] + '"><i class="fa fa-minus-circle"></i> ' + item['label'] + '<input type="hidden" name="service_nrelated[]" value="' + item['value'] + '" /></div>');	
	}	
});

$('#service-nrelated').delegate('.fa-minus-circle', 'click', function() {
	$(this).parent().remove();
});
//--></script> 
<script type="text/javascript"><!--
...
<?php if ($bservice_html_editor == 'ckeditor') { ?>
...
<?php } elseif ($bservice_html_editor == 'tinymce') { ?>
...
function addGallery() {
  let html = '';
	...
	html += '    <td class="text-left"><a href="" id="thumb-image' + image_row + '-gallery" data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="service_gallery[' + image_row + '][image]" value="" id="input-image' + image_row + '" /></td>';
	html += '    <td class="text-left hidden">';
		<?php foreach ($languages as $language) { ?>
			html += '	<img style="margin: 10px;" src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><textarea name="service_gallery[' + image_row  + '][text][<?php echo $language['language_id']; ?>]" rows="2" cols="30"></textarea><br />';
		<?php } ?>
	html += '</td>';
	html += '    <td class="text-right hidden"><input type="text" name="service_gallery[' + image_row + '][sort_order]" value="" size="2" /></td>';
	html += '    <td class="text-left"><a onclick="$(\'#image-row' + image_row  + '\').remove();" class="button btn btn-danger"><?php echo $button_remove; ?></a></td>';
	html += '  </tr>';
...
function addVideo() {
	...
	html += '  <tr>';
	html += '    <td class="left"><input type="text" name="service_video[' + video_row + '][video]" value="" size="20" /></td>';
	html += '    <td class="left">';
		<?php foreach ($languages as $language) { ?>
			html += '	<img style="margin: 10px;" src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /><textarea name="service_video[' + video_row  + '][text][<?php echo $language['language_id']; ?>]" rows="2" cols="30"></textarea><br />';
		<?php } ?>
	html += '</td>';
	html += '    <td class="left"><input type="text" name="service_video[' + video_row + '][width]" value="" size="3" /><input type="text" name="service_video[' + video_row + '][height]" value="" size="3" /></td>';
	html += '    <td class="right"><input type="text" name="service_video[' + video_row + '][sort_order]" value="" size="2" /></td>';
