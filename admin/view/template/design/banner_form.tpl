              ...
              <table id="images<?php echo $language['language_id']; ?>" class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr id="image-row<?php echo $image_row; ?>">
                    <td class="text-left">
                      ...
                      <!-- <textarea rows="3" class="form-control" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][title]" ><?php echo $banner_image['title']; ?></textarea> -->
                    ...
                    <p>Button Color</p>
                    <input type="text" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][btn_color]" value="<?php echo $banner_image['btn_color']; ?>" placeholder="Button Color" class="form-control" />
                ...
                <?php if ($fm_installed == 0) { ?>
                    ...
                    <script type="text/javascript">
                        CKEDITOR.replace("banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][description]",
                        {
                        baseHref: "<?= $base_url; ?>",
...
function addImage(language_id) {
  ...
  <p>Description</p><textarea rows="3" class="form-control" name="banner_image[' + language_id + ']['+ image_row +'][description]" ></textarea></span><p>Text Align</p><select class="form-control" name="banner_image[<?php echo $language['language_id']; ?>][<?php echo $image_row; ?>][textalign]"><option value="left" <?php echo ($banner_image['textalign']=="left" )?'selected':''; ?> > Left </option><option value="center" <?php echo ($banner_image['textalign']=="center" )?'selected':''; ?> > Center </option><option value="right" <?php echo ($banner_image['textalign']=="right" )?'selected':''; ?> > Right </option></select>
  <p>Button Color</p><input type="text" name="banner_image[<?php echo $language['+ language_id +']; ?>][<?php echo $image_row; ?>][btn_color]" value="" placeholder="Button Color" class="form-control" />
  </td>';
