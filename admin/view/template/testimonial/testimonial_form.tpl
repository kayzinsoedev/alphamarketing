    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-review" class="form-horizontal">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-text">Short Excerpt</label>
            <div class="col-sm-10">
              <textarea name="short_excerpt" cols="60" rows="8" placeholder="Short Excerpt" id="input-text" class="form-control"><?php echo $short_excerpt; ?></textarea>
            </div>
          </div>
