																...
																<?php foreach ($languages as $language) { ?>
																		...
																		<div class="tab-pane" id="tab-section-<?php echo $section_row; ?>-<?php echo $group_row; ?>-<?php echo $language['language_id']; ?>">
																			...
																			<div class="form-group">
																				...
																				<div class="col-sm-10"><textarea name="faq_manager_sections[<?php echo $section_row; ?>][groups][<?php echo $group_row; ?>][answer][<?php echo $language['language_id']; ?>]" id="description-<?php echo $section_row; ?>-<?php echo $group_row; ?>-<?php echo $language['language_id']; ?>" 
																					
																					class="<?php if ($ckeditor_enabled == 1) { ?>form-control<?php } else { ?>form-control summernote-<?php echo $group_row; ?><?php } ?>"
																					
																					><?php echo isset($value['answer'][$language['language_id']]) ? $value['answer'][$language['language_id']] : ''; ?></textarea>
																			...
																			<?php if ($fm_installed == 0) { ?>
																				<?php if ($ckeditor_enabled == 1) { ?>
																					<script type="text/javascript">
																							CKEDITOR.replace("description-<?php echo $section_row; ?>-<?php echo $group_row; ?>-<?= $language['language_id']; ?>", { 
																								baseHref: "<?= $base_url; ?>", 
...
<script type="text/javascript">
	...
	function addGroup(section_row) {
		...
		<?php foreach ($languages as $language) { ?>
			...
			html += '			<div class="col-sm-10"><textarea name="faq_manager_sections[' + section_row + '][groups][' + group_row + '][answer][<?php echo $language['language_id']; ?>]" id="description-' + section_row + '-' + group_row + '-<?php echo $language['language_id']; ?>" class="<?php if ($ckeditor_enabled == 1) { ?>form-control<?php } else { ?>form-control summernote-' + group_row + ' form-control<?php } ?>"></textarea></div>';
			html += '		</div>';
		...
		<?php if ($fm_installed == 0) { ?>
			<?php if ($ckeditor_enabled == 1) { ?>				
					<?php foreach ($languages as $language) { ?>
						CKEDITOR.replace("description-"+ section_row +"-"+ group_row +"-<?= $language['language_id']; ?>", { 
							baseHref: "<?= $base_url; ?>", 
							language: "<?= $language['code']; ?>", 
							filebrowserBrowseUrl: 'index.php?route=common/filemanager&token=<?= $token; ?>', 
							filebrowserImageBrowseUrl: 'index.php?route=common/filemanager&token=<?= $token; ?>', 
