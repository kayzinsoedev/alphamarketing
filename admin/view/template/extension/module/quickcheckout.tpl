					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="tab-delivery">
							...
							<div class="row">
								...
								<div class="form-group col-sm-6">
									<label class="col-sm-4 control-label" for="input-delivery-cut-off"><span title="eg. if user choose today date and the time is more than or equal this preset value, the delivery date will push to tomorrow " data-toggle="tooltip">Delivery Cut Off Time <br>(HH:MM:SS)<br>24 Hour Format<br>(Only work when user select Today date)</span></label>
									<div class="col-sm-8">
								...
								<table id="delivery-time" class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<span title="eg. if user choose today date and the time is more than or equal this preset value, this delivery time will be hide by the system to prevent user to select" data-toggle="tooltip"><?php echo $entry_delivery_times_cutoff; ?></span>
											</td>
