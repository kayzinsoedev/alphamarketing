...
<div class="tab-pane" id="tab-address<?php echo $address_row; ?>">
    ...
    <div class="col-sm-10">
        <input type="text" name="address[<?php echo $address_row; ?>][telephone]" value="<?php echo $address['telephone']; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-lastname<?php echo $address_row; ?>" class="form-control" />
