...
class ModelExtensionModuleTestimonial extends Model {
	...
	public function addReview($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "review SET author = '" . $this->db->escape($data['author']) . "', image = '" . $this->db->escape($data['image']) . "', text = '" . $this->db->escape(strip_tags($data['text']))  . "', short_excerpt = '" . $this->db->escape($data['short_excerpt']) . "', rating = '" . (int)$data['rating'] . "', status = '" . (int)$data['status'] . "', date_added = '" . $this->db->escape($data['date_added']) . "'");
