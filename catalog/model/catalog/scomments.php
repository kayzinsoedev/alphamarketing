<?php
class ModelCatalogScomments extends Model {		
	...
	public function getTotalScommentsByNewsId($news_id) {
	...
	public function getTotalJScommentsByNewsId($news_id, $reply_id = 0) {
