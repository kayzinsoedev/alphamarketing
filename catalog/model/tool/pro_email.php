  ...
  private function getDefaultInvoice($order_info) {
    ...
    foreach ($products as $product) {
      ...
      foreach ($options as $option) {
        ...
        $option_image = $this->model_tool_image->resize($this->getProductOptionImageByProductID($product['product_id'], $option['product_option_value_id']), $this->config->get('proemail_thumbwidth') ? $this->config->get('proemail_thumbwidth') : 40, $this->config->get('proemail_thumbheight') ? $this->config->get('proemail_thumbheight'): 40);
