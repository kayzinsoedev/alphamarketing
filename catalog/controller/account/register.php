...
// 		}
	...
	public function index() {
		...
		$data['text_sign_up_with_email'] = $this->language->get('text_sign_up_with_email');
		...
		*/
		...
		$gender = array(
			"0"	=> array("label" => "Male","value" => "male"),
			"1"	=> array("label" => "Female","value" => "female")
		);
		...
		$cases = array(			
			...
			'gender'		=>	array('type' => 'select',		'parent_class' => '', 			'extra_class' => '', 				'list' => $gender),
