...
class ControllerStartupStartup extends Controller {
	public function index() {
		...
		// BackendCart
		$this->registry->set('backendcart', new Cart\Backendcart($this->registry));
		...
		// Timeslot
		$this->registry->set('timeslot', new Timeslot($this->registry));

		// Mobile Detector
		$this->registry->set('mobile_detect', new Mobile_Detect());
