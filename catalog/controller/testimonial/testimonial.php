...
class ControllerTestimonialTestimonial extends Controller{
    ...
    public function index(){
        ...
        $testimonial_layout = $data['testimonial_layout'] = $this->config->get('config_testimonial_layout');
        ...
        foreach ($results as $result) { 
            $data['testimonials'][] = array(
                ...
                'description'   =>  nl2br(html($result['text'])),
                'short_excerpt'   =>  html($result['short_excerpt']),
