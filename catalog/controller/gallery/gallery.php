...
class ControllerGalleryGallery extends Controller {
	public function index() {
		...
		if ($gallimage_info) {
			...
			$data['gallery_layout'] = $gallery_layout = $this->config->get('config_contact_us_layout');
		
            // $this->response->setOutput($this->load->view('gallery/gallery', $data));    

			$this->response->setOutput($this->load->view('information/gallery_'.$gallery_layout , $data));
