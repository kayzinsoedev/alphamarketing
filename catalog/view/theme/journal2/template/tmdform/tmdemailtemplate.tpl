        ...
        <table style="width:100%">
          <tbody>
            ...
            <?php if($customer_name) { ?>
             ...
             <?php } else { ?>
             <td class="text-left" style="padding: 8px;line-height: 1.42857;vertical-align: top;border-top: 1px solid #ddd;"><a style="text-decoration: none;font-size: 12px;color: #333;">Guest</a></td>
             <?php } ?>
            </tr>
            <tr>
