						...
						<div class="panel panel-default">
							<div class="panel-heading" role="tab" id="heading<?php echo $value['inner_counter']; ?>">
								<h4 class="panel-title">
									<a role="button" data-toggle="collapse" data-parent="#accordion-<?php echo $section['counter']; ?>" href="#collapse<?php echo $value['inner_counter']; ?>" class="<?php if($value['inner_counter'] == 1) { echo ""; } else { echo 'collapsed';} ?>" aria-expanded="true" aria-controls="collapse<?php echo $value['inner_counter']; ?>"><?php echo $value['question']; ?></a>
								</h4>
							</div>
