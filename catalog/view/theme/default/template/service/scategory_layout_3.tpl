<?php if ($article) { ?>
	<div class="news-list-wrap flex flex-wrap">
		<?php foreach ($article as $articles) { ?>
			<div class="news-post service w100 flex-vcenter flex mg-b30">

				<div class="article-image-wrapper flex-2 relative hover-overlay">
					<?php if ($articles['thumb']) { ?>
					<a href="<?php echo $articles['href']; ?>">
						<div class="cover-bg transition center-bg pd-b50p" style="background-image:url('<?php echo $articles['thumb']; ?>');"></div>
						<?php /* ?>
