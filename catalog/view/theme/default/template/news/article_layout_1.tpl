<div class="article-inner">
	<div class="pd-md-60">
		...
		<div class="pd-b15 flex-vcenter date-added flex"><div class="calendar-icon">
			<!-- <img src="image/catalog/cal-min.png"/> -->
		</div>
			<?php $date = date_create($articles['date_added']); ?>
			<div class="art-inner-date"><span style="color: #068450;"><?php echo date_format($date, 'd M Y'); ?></span></div>
		</div>

		<div class="pd-b15" style="text-align: justify;"><?php echo $description; ?></div>
	</div>
