...
<div class="container custom-attribute">
...
<?php if ($review_status) { ?>
  <li class="<?php if (!$attribute_groups) { ?> active <?php } ?>"><a href="#tab-review" data-toggle="tab"><?= $tab_review; ?></a></li>
<?php } ?>
</ul>
...
<?php if ($review_status) { ?>
<div class="tab-pane <?php if (!$attribute_groups) { ?> active <?php } ?>" id="tab-review">
