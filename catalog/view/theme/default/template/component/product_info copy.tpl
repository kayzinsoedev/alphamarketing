		...
		<div class="product-image-block transition relative image-zoom-hover">
			...
			<div class="btn-group product-button">
				...
				<?php } else { ?>
					...
					<?php if(!$enquiry){ ?>
						<?php if(!$not_avail) { ?>
							<button type="button" data-loading-text="<?= $text_loading; ?>" class="btn btn-primary btn-cart btn-cart-<?= $product_id; ?>" data-product-id="<?= $product_id; ?>"><?= $button_cart; ?><img style="width: 20px; margin-left: 6px; margin-top: 4px" src="./image/catalog/AlphaPoineer/general/arrow.png"/></button>
						<?php }else{ ?>
		...
		<!--<div class="product_box_detail">-->
			...
			<div class="flex price_button">
				...
				<div class="cart-buttons" style="float: right;">
					...
					<?php if(!$enquiry){ ?>
						<?php if(!$not_avail) { ?>
							<button type="button" data-loading-text="<?= $text_loading; ?>" class="btn btn-primary btn-cart btn-cart-<?= $product_id; ?>" data-product-id="<?= $product_id; ?>"><?= $button_cart; ?><i class="fa fa-arrow-right" style="width: 30px"></i></button>
						<?php }else{ ?>
							<button type="button" data-loading-text="<?= $text_loading; ?>" class="btn btn-primary btn-cart btn-cart-<?= $product_id; ?>" disabled data-product-id="<?= $product_id; ?>">Out of stock</button>
						<?php } ?>
					<?php }else{ ?>
