<?php if($status == 1) { ?>
<div class="f-build-title"><?php echo $formtitle; ?></div>
<div class="formbulider container">
				...
				<?php if ($form_fields) { ?>
						<?php foreach ($form_fields as $optionfield) { ?>
							...
							<?php if ($optionfield['type'] == 'text') { ?>
								<div class="col-md-6 col-sm-6 col-xs-12 form-group<?php echo ($optionfield['required'] ? ' required' : ''); ?>">
									<label class="control-label" for="input-formfields<?php echo $optionfield['field_id']; ?>">
										...
										<input type="text" name="formfields[<?php echo $optionfield['field_id']; ?>]" value="" placeholder="<?php echo $optionfield['placeholder']; ?>" id="input-formfields<?php echo $optionfield['field_id']; ?>" class="form-control" style="width: 100%" />
								</div>
							<?php } ?>
							<?php if ($optionfield['type'] == 'textarea') { ?>
								<div class="col-md-12 col-sm-12 col-xs-12 form-group<?php echo ($optionfield['required'] ? ' required' : ''); ?>">
									<label class="control-label" for="input-formfields<?php echo $optionfield['field_id']; ?>">
									<?php if(!empty($optionfield['help_text'])) { ?><span data-toggle="tooltip" title="<?php echo $optionfield['help_text']; ?>"> <?php }?>
									<?php echo $optionfield['field_name']; ?>
									<?php if(!empty($optionfield['help_text'])) { ?> <i class="fa fa-question-circle" aria-hidden="true"></i> </span><?php } ?>
									</label>
									<textarea name="formfields[<?php echo $optionfield['field_id']; ?>]" rows="8" placeholder="<?php echo $optionfield['placeholder']; ?>" id="input-formfields<?php echo $optionfield['field_id']; ?>" class="form-control" style="width: 100%"></textarea>
								</div>
							<?php } ?>
