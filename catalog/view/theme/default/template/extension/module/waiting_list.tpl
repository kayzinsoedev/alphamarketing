<div id="waiting_list">
    <div class="waiting_list_container">
        ...
        <?php } ?>
        <div class="flex-group flex-wrap flex-just-cont-center relative">
            <input name="email" placeholder="<?= $entry_email; ?>" value="<?= $email; ?>" class="pd-5 " />
            <button id="waiting_list_submit" type="button" class="btn btn-primary btn-inner" ><?= $button_submit; ?></button>
        </div>
    </div>
