...
<div>
  ...
  <div class="col-sm-6 required">
	...
	<input type="password" name="confirm" value="" class="form-control" placeholder="<?php echo $entry_confirm; ?>" />
  </div>
  <?php if($event_day){ ?>
  <div class="col-sm-6 required">
	<input id="birthday" name="birthday" type="text" class="form-control birthday" value="" placeholder="Birthday" readonly>
  </div>
  <?php } ?>
