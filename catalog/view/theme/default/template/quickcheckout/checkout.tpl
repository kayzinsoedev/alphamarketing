  ...
  <div class="row"><?php // $column_left; // use for social login  ?>
    ...
    <div id="content" class="<?php echo $class; ?>">
      <h2><?php echo $heading_title; ?></h2> 
		...
		<ul class="checkout_step">
				<li class="first_step active">Step 1 of 3: Account & Billing Details</li>
				<li class="second_step">Step 2 of 3: Order Review and Payment</li>
				<li class="third_step">Step 3 of 3: Order Success</li>
		</ul>
	  <!-- Start -->
...
<?php if ($shipping_required) { ?>
	function reloadShippingMethod(type) {
		...
		$.ajax({
			url: 'index.php?route=quickcheckout/shipping_method'+"&shipping_code="+$('#shipping-method input[type=\'radio\']:checked').attr('data-code'),
			type: 'post',
			data: post_data,
			dataType: 'html',
			cache: false,
	...
	function reloadShippingMethodById(address_id) {
		$.ajax({
			url: 'index.php?route=quickcheckout/shipping_method&address_id=' + address_id+"&shipping_code="+$('#shipping-method input[type=\'radio\']:checked').attr('data-code'),
			type: 'post',
	...
	function validateShippingMethod() {
		$.ajax({
			url: 'index.php?route=quickcheckout/shipping_method/validate&shipping_code='+$('#shipping-method input[type=\'radio\']:checked').attr('data-code'),
			type: 'post',
...
<?php if ($shipping_required) { ?>
$(document).on('focusout', 'input[name=\'postcode\'], input[name=\'unit_no\']', function() {
	<?php if (!$logged) { ?>
	if ($('#payment-address input[name=\'shipping_address\']:checked').val()) {
		reloadShippingMethod('payment');
	} else {
