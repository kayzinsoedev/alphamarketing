<link rel="stylesheet" href="./controller/extension/module/logo-showcase-assets/popup.css">

<div class="eapps-deactivation-popup-overlay"></div>

<div class="eapps-deactivation-popup">
    <form method="post" id="logo-showcase-deactivateForm" action="">
        <div class="eapps-deactivation-popup-header">
            <div class="eapps-deactivation-popup-header-heading">You have succesfully uninstalled Elfsight Logo Showcase</div>
...
<script>
    ...
    node.async = true;
    node.src = './controller/extension/module/logo-showcase-assets/popup.js';
